...
<html>
<head>
    <title>Discussion - <?= htmlspecialchars($taREMOVED>title) ?></title>
...
<div class="container py-4">
    <h4 class="mb-4">💬 Discussion pour la tâche : <?= htmlspecialchars($taREMOVED>title) ?></h4>
    ...
    <form method="post" action="<?= site_url('tasks/send_message/' . $taREMOVED>idtask) ?>" class="mt-4 d-flex">
