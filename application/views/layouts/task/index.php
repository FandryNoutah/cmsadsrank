...
<div class="container-fluid">
	<ul class="nav nav-tabs mb-3" role="tablist">
		<li class="nav-item">
			<a class="nav-link py-3 active taREMOVEDfilter-button" data-type="0" type="button">
				All Task
			</a>
		</li>
		<li class="nav-item">
			<a class="nav-link py-3 taREMOVEDfilter-button" data-type="1" type="button">
				Team Task
			</a>
		</li>
		<li class="nav-item">
			<a class="nav-link py-3 taREMOVEDfilter-button" data-type="2" type="button">
				Temporaire
			</a>
		</li>
		<li class="nav-item">
			<a class="nav-link py-3 taREMOVEDfilter-button" data-type="3" type="button">
				GTM
			</a>
		</li>
		<li class="nav-item">
			<a class="nav-link py-3 taREMOVEDfilter-button" data-type="4" type="button">
				Plan de taggage
			</a>
		</li>
	</ul>
					...
					<tbody>
						<?php foreach ($tache as $t):  ?>
							<?php if ($t->status == "planifié"): ?>
								<tr class="taREMOVEDfilter" data-type="<?= $t->type_tache ?>" data-am="<?= $t->AM; ?>">
									<td>
										<h6 class="mb-0 ml-3">
											<?= $t->nom_client; ?>
										</h6>
				...
				<div class="col mb-3">
					<div class="card" style="border-radius: 8px;">
						<div class="card-body">
							...
							<?php foreach ($tache as $t): ?>
								<?php if ($t->status == "planifié"): ?>
									<div class="card mt-3 taREMOVEDfilter" data-type="<?= $t->type_tache ?>" data-am="<?= $t->AM; ?>">
										<div class="card-body">
											<div class="d-flex">
												<?php if ($t->type_tache == 1): ?>
													<div class="mr-2">
...
<script>
	$(function() {
		...
		$('.taREMOVEDfilter-button').click(function() {

			let type = $(this).data('type');
			$('.taREMOVEDfilter-button').removeClass('active');
