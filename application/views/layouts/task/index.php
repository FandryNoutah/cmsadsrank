							...
							<div class="card mt-3">
								<div class="card-body">
									<div class="d-flex">
										...
										<div class="dropdown no-arrow">
											<a href="javascript:void(0);" class="col-auto ml-auto text-decoration-none text-muted ta***REMOVED*** dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="false">
												<i class="fa fa-ellipsis-h"></i>
											</a>
											<div class="dropdown-menu dropdown-menu-right">
												<a href="#" class="dropdown-item">Détails</a>
