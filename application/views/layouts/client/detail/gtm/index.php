    ...
    <div class="col" style="height: calc(100vh - 101px); overflow-y:auto;">
        <div class="container-fluid pb-5">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link py-3 active" type="button" id="gtm_tab" data-toggle="tab" data-target="#gtm" role="tab" aria-controls="list" aria-selected="true">
                        ...
                        <div class="modal fade" id="formModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form id="gtmEditForm" action="<?= base_url('Client/update_gtm') ?>" method="POST">
...
$(document).ready(function () {
    $(document).on('click', '[data-target="#formModal"]', function () {
        ...
        $.ajax({
            url: '<?= base_url("Client/get_gtm_by_id/") ?>' + id,
            method: 'GET',
            dataType: 'json',
