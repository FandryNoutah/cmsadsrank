				...
				<?php else: ?>
					...
					<div class="container-fluid pt-4">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nom_campagne_pmax" id="nom_campagne_pmax" value="<?= $d['nom_client'] ?> - Local">
						</div>

						<div class="form-group">
							<label for="url_campagne">URL de la campagne</label>
							<input type="url" class="form-control" name="url_campagne" id="url_campagne" value="<?= $d['site_client'] ?>">
						</div>
						...
						<div id="groupe_annonce_container" class="mb-4 pt-4">
									<div class="group-annonce-content">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="groupe_annonce" value="<?= $d['nom_client'] ?> - Groupe d'annonce - Local">
										</div>
										<div class="form-group">
						...
						<div class="form-group">
							<label for="">De quels magasins vos annonces doivent-elles faire la promotion ?</label>
							<textarea name="magasin" class="form-control" ></textarea>
						</div>
						...
						<div class="form-group">
							...
							<textarea name="produit" class="form-control" ></textarea>
						</div>
