...
<head>
  ...
  <title>Modifier l'annonce – Local (style PMax)</title>
    ...
    <div class="col-12 col-lg-6 order-lg-2">
      <form action="<?= base_url('Client/update_annonce') ?>" method="POST" enctype="multipart/form-data">
        <div class="container-fluid pt-2">
          <h5>Modifier l’annonce (Local)</h5>
          <hr class="my-3">
          ...
          <!-- Description brève (spécifique Local/PMax) -->
...
$(function(){
  ...
  /* ===== Aperçu mobile (titre/desc/brief + meta) ===== */
  function updatePhonePreview() {
    ...
    // On affiche au max 2 blocs de texte (brief prioritaire)
    const desc = ([brief, ...ds].filter(Boolean).slice(0,2).join(' — '))
...
function annexeTpl(){
  ...
  /* ===== Live update ===== */
  $(document).on('input',
    'input[name="titres[]"], input[name="titres_longs[]"], input[name="descriptions[]"], input[name="titre_annexe[]"], input[name="desc1_annexe[]"], input[name="desc2_annexe[]"], input[name="url_annexe[]"], input[name="accroche_annexe[]"], input[name="site_annexe[]"], input[name="numero"], input[name="adresse"], input[name="description_breve"], #url_campagne',
