	...
	<div class="container-fluid p-0 h-100">
		<div class="row no-gutters h-100">
			...
			<?php if (isset($campagne)): ?>
				<form action='<?= site_url('Client/ajout_campagne/' . $idclients) . "?id_camp=$id_camp" ?>' method="POST">
			<?php else: ?>
			...
			<?php endif; ?>
					...
					<div class="container-fluid pt-4">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nom_campagne_search" id="nom_campagne_search" value="<?= isset($campagne) ? $campagne->nom_campagne : '' ?>">
						</div>

						<div class="form-group">
							<label for="information_campagne_search">Information de la campagne</label>
							<textarea class="form-control" name="information_campagne_search" id="information_campagne_search"><?= isset($campagne) ? $campagne->information_campagne : '' ?></textarea>
						</div>

						<div class="form-group">
							<label for="url_campagne">URL de la campagne</label>
							<input type="url" class="form-control" name="url_campagne" id="url_campagne" value="<?= isset($campagne) ? $campagne->url_site : '' ?>">
						</div>

						<div class="form-group">
							<label for="repartition_budget_search">Budget de la campagne</label>
							<input type="number" class="form-control" name="repartition_budget_search" id="repartition_budget_search" value="<?= isset($campagne) ? $campagne->repartition_budget : '' ?>">
						</div>

						<div class="custom-control custom-switch">
							<input type="checkbox" class="custom-control-input" id="multiple_groupe_annonce" <?php if (isset($campagne) && count($groupes_annonces) > 0): ?> checked <?php endif; ?>>
								...
								<?php foreach ($groupes_annonces as $groupe_annonce): ?>
									<div class="group-annonce-content">
										...
										<div class="form-group">
											...
											<textarea name="contexte_groupe_annonce[]" class="form-control" maxlength="50"><?= $groupe_annonce['contexte_groupes_annonces'] ?></textarea>
										</div>
										<div class="form-group">
											<label>Saisir des mots-clés du groupe d'annonce</label>
											<textarea name="Mot_cle[]" class="form-control" maxlength="50"><?= $groupe_annonce['mot_cle'] ?></textarea>
										</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="zone_search" id="zone_search" value="<?= isset($campagne) ? $campagne->zones : '' ?>">
						</div>
