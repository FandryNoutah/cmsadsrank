								...
								<div class="row row-cols-5 mb-4">
										...
										<div class="phone-frame">
											<div class="screen">
												...
												<div class="thumb-box mb-3" style="height: 140px;">
													<img src=<?= $groupe['images'][0] ?? "https://placehold.co/120x120?text=Gmail+Attachment" ?> alt="placeholder">
												</div>
									...
									<div class="col-auto">
										<div class="phone-frame">
											<div class="screen">
												<div class="thumb-box mb-3" style="height: 140px;">
													<img src=<?= $groupe['images'][0] ?? "https://placehold.co/120x120?text=Display" ?> alt="placeholder">
												</div>
												<div class="row no-gutters justify-content-start mb-2">
													<div class="col-auto">
														<img src="https://placehold.co/38x38?text=Favicon" alt="" class="rounded-circle" width="38">
										...
										<div class="phone-frame">
											<div class="screen">
												...
												<div class="thumb-box mb-3" style="height: 220px;">
													<img src=<?= $groupe['images'][0] ?? "https://placehold.co/120x120?text=Discovery" ?> alt="placeholder">
													<span class="bg-white position-absolute text-primary" style="right: 2px; top: 2px; padding: 0px 2px;">
														<i class="fa fa-info-circle"></i>
													</span>
												</div>
												<h6 class="mb-3"><?= $groupe['descriptions1'] ?></h6>
