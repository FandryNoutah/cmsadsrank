	...
	<div class="modal-dialog modal-dialog-scrollable" style="max-width: 600px;">
		<div class="modal-content p-3">
			<div class="card overflow-auto">
				...
				<form action="<?= base_url("Client/insert_client") ?>" enctype="multipart/form-data" method="post" enctype="multipart/form-data">
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<select class="form-control" name="product_choice" id="product">
								<?php foreach ($produit as $d): ?>
									<option value="<?= $d->idproduit ?>"><?= $d->label_produit ?></option>
								<?php endforeach; ?>
							</select>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label  for="dejaclient">Déja client</label>
							<select class="form-control" name="dejaclient" required>
