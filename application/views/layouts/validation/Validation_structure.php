...
<?php $F = $donne_valider[0]['idclients'];
    $F = intval($F);
?>
<div class="row" style="width: 200px; margin-top: 50px; margin-bottom: 250px;">
    <div class="col-lg-3">
        <?php echo anchor(
            "Googleads/save_campagne_clients/".$F, 
            '<h6 class="btn btn-secondary mr-1" style="text-decoration: none; background-color: #bcf4db; color: #052740; padding: 10px 15px; border-radius: 12px; font-size: 14px; margin-left: 10px; font-family: \'Product Sans\', sans-serif; border: none;">
