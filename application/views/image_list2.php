...
<div class="container">
    ...
    <?php if (!empty($Images_recup)): ?>
        ...
        <form action="<?= site_url('Validation/ajouter_images_recup'); ?>" method="POST">
    ...
    <?php echo anchor("Validation/validation_structure/".$clients->idclients, '<h6 style="width: 180px; height: 41px; background-color: #4EA5FE; color: white; border-radius: 20px;" class="btn">Enregistrer</h6><i class="button"></i>', 'data-edit="'.$clients->idclients.'"'); ?>
            <?php endif; ?>  
    ...
    <div class="tab-content" id="imageTabsContent">
        ...
        <div class="tab-pane fade" id="url" role="tabpanel" aria-labelledby="url-tab">
            <div class="upload-container">
                ...
                <button type="submit" style="width: 180px; height: 41px; background-color: #4EA5FE; color: white; border-radius: 20px;" class="btn">Ajouter par URL</button>
                <?php echo form_close(); ?>
            </div>
        </div>
        
        <div class="tab-content" id="imageTabsContent">
        <!-- Onglet pour récupérer les images -->
        <div class="tab-pane fade" id="gallery" role="tabpanel" aria-labelledby="gallery-tab">
            <div class="upload-container">
                <h4>Récupérer les images d'un site Web</h4>
                <form method="POST" action="<?= site_url('Validation/gestion_image/'.$idgroupe_annone ); ?>">
