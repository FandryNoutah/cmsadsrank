							...
							<form action="<?php echo site_url('Googleads/Ajoutextensions'); ?>" method="POST" enctype="multipart/form-data">
                                    <div id="annonce-groups">
                                        ...
                                        document.addEventListener("DOMContentLoaded", function() {
                                            const textareas = document.querySelectorAll('textarea[name="extensions_accroche"]');
                                            ...
                                            textareas.forEach(textarea => {
                                                textarea.addEventListener("input", function() {
                                                    ...
                                                    for (let i = 0; i < value.length; i += 25) {
                                                        formatted += value.slice(i, i + 25) + '\n';
                                                    }

                                                    textarea.value = formatted.trimEnd();
                                                });
                                            });
                                        });
                                        </script>
                                    ...
                                    <a href="javascript:void(0);" id="add-extension-btn" class="btn btn-primary" style="width: 250px;text-align: center; line-height: 41px; font-size: 16px; font-weight: 500; margin-top: 15px; background-color: #4EA5FE; color: white !important; border-radius: 35px; text-decoration: none; border: none;">
    Ajouter une extension
                                    ...
                                    <script>
                                        ...
                                        document.getElementById('add-extension-btn').addEventListener('click', function() {
											...
											<button type="submit" class="btn btn-success" style="margin-top: 20px;font-size: 16px; font-weight: 500;background-color: #4EA5FE;">Ajouter</button>
											</form>
                                            <?php endforeach; ?>
                                    </div>
                                    </div>
