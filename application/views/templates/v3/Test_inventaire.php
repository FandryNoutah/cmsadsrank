      ...
      <div class="box" data-model-id="40567:247867-frame">
        <div class="group">
          <div class="div">
            ...
            <p class="p">Location de Chalets de Luxe et d’Appartements à Serre Chevalier. Réservez dès Maintenant</p>
            ...
            <div class="div-3">
              ...
              <p class="r-sidence-luxe-https">
                ...
                <span class="text-wrapper-3">https://www.residence-luxe.com</span>
              </p>
            ...
            <div class="text-wrapper-13">Display</div>
            <div class="text-wrapper-14">Search</div>
            <div class="text-wrapper-15">Youtube</div>
            <div class="text-wrapper-16">Discovery</div>
            <div class="text-wrapper-17">Gmail</div>
            <img class="image-8" src="img/image-237.png" />
            <img class="img-3" src="img/2.png" />
            <div class="div-6">
            ...
            <img class="image-11" src="img/image-236.png" />
            ...
            <img class="image-17" src="<?php echo $image_src; ?>" />
            <img class="display-icon" src="img/display-icon-48-4.png" />
            <img class="image-18" src="img/image-238.png" />
            <img class="discover-icon" src="img/discover-icon-48-3.png" />
            <img class="image-19" src="img/image-239.png" />
          </div>
        </div>
      </div>
     </div>
