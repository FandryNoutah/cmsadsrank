...
<div id="exportable-content">
    <h1>Gestion extension <?php  foreach($clients as $C): ?>
        <?php echo $C['nom_client']; ?>
                   ...
                   <?php //echo anchor("Googleads/campagne/".$C['idclients'],'<span style="margin-right: 20px;display: inline-block; text-align: center; line-height: 41px; font-size: 16px; font-weight: 500; margin-top: 20px; width: 60px; height: 41px; background-color: #4EA5FE; color: white !important; border-radius: 20px; text-decoration: none;"> <i class="fa fa-arrow-left" style="margin-right: 8px;"></i></span>','data-edit="'.$C['idclients'].'"'); ?>

<?php echo anchor(
    "Googleads/ajoutextension/".$C['idclients'],
    '<span style="margin-right: 20px;display: inline-block; text-align: center; line-height: 41px; font-size: 16px; font-weight: 500; margin-top: 20px; width: 180px; height: 41px; background-color: #4EA5FE; color: white !important; border-radius: 20px; text-decoration: none;">
        Ajout extension
    </span>',
...
<?php echo anchor(
    "Googleads/exclusion/".$C['idclients'],
    '<span style="margin-right: 20px;display: inline-block; text-align: center; line-height: 41px; font-size: 16px; font-weight: 500; margin-top: 20px; width: 180px; height: 41px; background-color: #4EA5FE; color: white !important; border-radius: 20px; text-decoration: none;">
        Exclusion
    </span>',
    'data-edit="'.$C['idclients'].'" class="open-popup"'
); ?>

<?php echo anchor(
    "Googleads/plandetaggage/".$C['idclients'],
    '<span style="margin-right: 20px;display: inline-block; text-align: center; line-height: 41px; font-size: 16px; font-weight: 500; margin-top: 20px; width: 180px; height: 41px; background-color: #4EA5FE; color: white !important; border-radius: 20px; text-decoration: none;">
        Plan de taggage
    </span>',
    'data-edit="'.$C['idclients'].'"'
...
<?php echo anchor(
    "Googleads/campagne/".$C['idclients'],
    '<span style="margin-right: 20px;display: inline-block; text-align: center; line-height: 41px; font-size: 16px; font-weight: 500; margin-top: 20px; width: 120px; height: 41px; background-color: #4EA5FE; color: white !important; border-radius: 20px; text-decoration: none;">
        Suivant
    </span>',
    'data-edit="'.$C['idclients'].'"'
); ?>
...
<?php endforeach; ?>                         
    ...
    <thead>
        <tr>
            <th></th>
            <th style="width: 450px;">Extensions de liens annexes</th>
    ...
    <tbody>
        ...
        ?>
            <tr> <td> 
           <?php //echo $E['idextensions']; ?> 
            <?php echo anchor("Googleads/editextensions/".$E['idextensions'], '<i class="fas fa-edit" style="color: #949cab;"></i>','data-edit="'.$E['idextensions'].'"'); ?>
                        <?php echo anchor("Googleads/deleteextension/".$E['idextensions'], '<i class="fas fa-trash" style="color: #949cab;"></i>', 'onclick="return confirm(\'Êtes-vous sûr de vouloir supprimer cette extension ?\');" data-edit="'.$E['idextensions'].'"'); ?>
                        </td>   
                <td>
                    <b><?php echo $E['titre_extensions']; ?></b><br /><br />
                    <?php echo nl2br(wordwrap($E['description_extensions'], 35, "\n", true)); ?><br /><br />
                    <a style="color: #4EA5FE"><?php echo $E['url_extensions']; ?></a>
                </td>
                <?php if ($i === 0): ?> 
                    <td rowspan="<?php echo $countG; ?>" style="text-align: center"><?php echo nl2br($E['extensions_accroche']); ?></td>
                    <td rowspan="<?php echo $countG; ?>" style="text-align: center"><?php echo nl2br($E['extensions_extrait_site']); ?></td>
                    <td rowspan="<?php echo $countG; ?>" style="width: 250px;"><?php echo $E['extensions_lieu']; ?></td>
                    <td rowspan="<?php echo $countG; ?>" style="text-align: center"><?php echo $E['extensions_appel']; ?></td>
                <?php endif; ?> 
            </tr>
        <?php 
            $i++; 
...
<div id="popupForm" style="display:none;">
    ...
    <button type="submit" style="font-size: 16px; font-weight: 500; background-color: #4EA5FE; color: white;border: none;">Valider</button>
</form>
