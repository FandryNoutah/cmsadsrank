...
<section id="">
	<div class="row">
		<div class="col-xs-6">
			<?php $this->load->view("templates/v3/parts/part-flags-openlayers",  ["locations" => $locations]); ?>
		</div>
...
<script type="text/javascript">
	$(function() {
        ...
        function loadAjax(checked) {
			...
			var params = [checked];
			params.push();
			var ajaxData = $("#filterData").serialize() + "&filters=" + filters + "&support=3";
		...
		function majCampagne(event){
			...
			if(allIdsCount <= 0){
				alert("Veuillez cocher les panneaux ?ettre ?our");
