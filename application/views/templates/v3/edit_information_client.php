...
<div class="col-md-13">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title" id="basic-layout-colored-form-control">Information <?php echo $D->nom_client; ?></h4>
			...
			<div class="card-block">
				...
				<form action="<?php echo site_url('Googleads/updateinformationClient'); ?>" method="POST" enctype="multipart/form-data">
						...
						<?php endforeach; ?>
                            ...
                            <div class="col-md-13">                                
								<div class="form-group">
									<label for="fname">Information Client : <img width="1%" style="margin-top: 0px; margin-left: 5px;" src="<?php echo base_url("assets/images/ico/gemini.png"); ?>" alt="WLB" title="WLB" /></label>
									<textarea class="form-control" name="information_client" rows="10" cols="100"><?php echo $D->information_client; ?></textarea>
								</div>
							</div>

							<div class="col-md-13">                                
								<div class="form-group">
									<label for="fname">Contexte Client : <img width="1%" style="margin-top: 0px; margin-left: 5px;" src="<?php echo base_url("assets/images/ico/gemini.png"); ?>" alt="WLB" title="WLB" /></label>
						...
						<div class="form-actions right">
                            ...
                            <input class="btn btn-warning mr-1" type="submit" name="update" style=" font-size: 16px; font-weight: 500; width: 180px; height: 41px; margin-left: 10px; background-color: #4EA5FC;color: white;  border-radius: 20px;" value="Enregister"/>
