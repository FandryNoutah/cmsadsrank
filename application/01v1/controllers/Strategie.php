...
class Strategie extends MY_Controller {
	...
	public function index() {
		...
		$this->data['teamtask_nocomplete'] = $this->Task_model->get_teamtask_nocomplete();
		$this->data['temporaire_nocomplete'] = $this->Task_model->get_temporaire_nocomplete();
		$this->data['gtm_nocomplete'] = $this->Task_model->get_gtm_nocomplete();
