...
<body>
    ...
    </div> <!-- Contenu de l'annonce -->
     <!-- Bouton Export PDF -->
     <div style="display: flex; align-items: center; gap: 10px;">
    <button class="export-btn" onclick="exportToPDF()">Exporter en PDF</button>
    
    <?php echo anchor("Googleads/edit_groupe/".$G['idgroupe_annonce'], '<h6 class="export-btn" style="width: 90px; text-align: center"> Modifier</h6><i class="button"></i>', 'data-edit="'.$G['idgroupe_annonce'].'"'); ?>
    
    <?php echo anchor("Validation_client/view/".$G['idgroupe_annonce'], '<h6 class="export-btn" style="width: 90px; text-align: center"> Lien client</h6><i class="button"></i>', 'data-edit="'.$G['idgroupe_annonce'].'" target="_blank"'); ?>
    </div>
