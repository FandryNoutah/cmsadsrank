...
<?php endif; ?>
    ...
    <button id="openPopupButton" style="background-color: #c3e7fd; color: #052740; padding-top: 15px; padding-bottom: 15px; border-radius: 15px; font-size: 14px; font-family: 'Product Sans', sans-serif !important;"> <i class="fas fa-eye" ></i> Information client</button>
   <?php echo anchor("Googleads/ajoutCampagne/".$D['idonnee'], 
    '<h6 class="btn btn-secondary mr-1" style="background-color: #c3e7fd; color: #052740; padding-top: 15px; padding-bottom: 15px; padding-right: 20px; padding-left: 20px; border-radius: 15px; font-size: 16px; margin-left: 15px; font-family: \'Product Sans\', sans-serif; border: none;"> <i class="fas fa-plus" ></i>  &nbsp;&nbsp;&nbsp;Ajout campagne</h6>', 
    'data-edit="'.$D['idonnee'].'"'); ?>
     <?php echo anchor("Googleads/save_campagne/".$D['idonnee'], 
    '<h6 class="btn btn-secondary mr-1" style="background-color: #bcf4db; color: #052740; padding-top: 15px; padding-bottom: 15px; padding-right: 20px; padding-left: 20px; border-radius: 15px; font-size: 16px; margin-left: 15px; font-family: \'Product Sans\', sans-serif; border: none;"> <i  ></i>  &nbsp;&nbsp;&nbsp;Envoyer au technique</h6>', 
    'data-edit="'.$D['idonnee'].'"'); ?>

    <?php echo anchor("Googleads/vision_globale/".$D['idclients'], 
    '<h6 class="btn btn-secondary mr-1" style="background-color: #c3e7fd; color: #052740; padding-top: 15px; padding-bottom: 15px; padding-right: 20px; padding-left: 20px; border-radius: 15px; font-size: 16px; margin-left: 15px; font-family: \'Product Sans\', sans-serif; border: none;"> <i  ></i>  &nbsp;&nbsp;&nbsp;Vision global</h6>', 
...
<?php
if($taggage != NULL):
if($taggage[0]['type_plan_taggage'] == NULL): ?>
    <form action="<?php echo site_url('Googleads/ajout_type_plan_taggage'); ?>" method="POST" enctype="multipart/form-data">
        <label for="choix">Choisissez type client :</label>
        <input type="hidden" name="idclients" value="<?php echo $taggage[0]['idclients']; ?>" />
...
<?php if($taggage[0]['type_plan_taggage'] != NULL): ?>
        <label for="choix">Type client : <?php echo $taggage[0]['type_plan_taggage']; ?> </label>
<?php endif; ?>
<?php endif; ?>
