...
$hide = array("id", "longitude", "latitude", "commentaire", "status");
						...
						<tbody>
							...
							<tr data-id="<?php echo $valueRow->id ?>">
								...
								<?php foreach($campagnes as $keyCampagne => $campagne) : ?>
									...
									<?php //$campagneVisuel = (array)$campagneVisuelArray; ?>
									<!--<td><?php //echo $campagneVisuel["id"] == $valueRow->id ? $campagneVisuel["visuel_actuel"] : "-"; ?></td>-->
									<!--<td><?php //echo $campagneVisuel["id"] . ' + ' . $valueRow->id; ?></td>-->
									<td><?php datadump($campagneVisuelArray[$valueRow->id]); ?></td>
									<!--<td><?php //echo $campagneVisuel["visuel_actuel"]; ?></td>-->
								<?php endforeach ?>
