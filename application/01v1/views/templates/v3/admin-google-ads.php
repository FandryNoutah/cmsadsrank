	...
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-header">
				...
				<button  data-toggle="modal" data-target="#inlineNew" style="background-color: #c3e7fd; color: #052740; padding-top: 15px; padding-bottom: 15px; border-radius: 15px; font-size: 14px; font-family: 'Product Sans', sans-serif !important;"><i class="far fa-plus-square" ></i>Nouveau</button>
		...
		<?php //endforeach; ?>
				...
				<table id="tableData" class="tableData table table-hover mb-0 table-striped table-bordered dt-responsive nowrap" width="100%" cellspacing="0" style="text-align: center! important;">
                    <thead>
                        <tr>
                            <th></th>
                    ...
                    <tbody>
                        <?php foreach($donnee as $C): ?>
							...
							<td>
								<a href="#" class="expand-row" data-id="<?php echo $C->idonnee; ?>">
                                ...
                                <!-- Initiative -->
                                <td>
                                    <img src="<?php //echo base_url(IMAGES_PATH . htmlspecialchars($C->photoinitiative)); ?>" alt="avatar" style="width: 40px;"><p style="display: none;"><?php echo htmlspecialchars($C->nomam); ?>
                                </td>
                
                                <!-- AM -->
                                <td>
                                    <img src="<?php //echo base_url(IMAGES_PATH . htmlspecialchars($C->photoam)); ?>" alt="avatar" style="width: 40px;"><p style="display: none;"><?php echo htmlspecialchars($C->nomam); ?>
                                </td>
                                ...
                                <td>
                                    <a class="openPopupBtn" data-id="<?php echo $C->idonnee; ?>">
                                        <?php echo ($C->date_validation_structure == '0000-00-00') ? 'Ajouter une date' : htmlspecialchars($C->date_validation_structure); ?>
                                    </a>
                                </td>
								<?php endif; ?>
                                ...
                                <td class="openPopupBtnPR" data-id="<?php echo $C->idonnee; ?>">
                                        ...
                                        <script>
                                            document.querySelector('.openPopupBtnPR').addEventListener('click', function() {
                                                ...
                                                document.getElementById('popupYesOrNoPR').style.display = 'block'; // Pour afficher le popup
                                            });
							...
							<tr class="expandable" id="details_<?php echo $C->idonnee; ?>" style="display: none; ;">
							<td colspan="18" style="text-align: left;">
								<?php echo anchor("Googleads/editclient/".$C->idonnee, '<i class="fas fa-edit"></i>', 'class="btn btn-sm btn-primary"'); ?>
								<?php echo anchor("Googleads/view/".$C->idonnee, '<i class="fas fa-eye"></i>', 'class="btn btn-sm btn-secondary"'); ?>
								<?php if($C->commentaire_client != NULL): ?>
									<?php echo anchor("Googleads/message/".$C->idonnee, '<i class="fas fa-envelope"></i>', 'class="btn btn-sm btn-info"'); ?>
								<?php endif; ?>
							</td>
							...
							<div id="popupYesOrNoPR" class="popup">
								<div class="popup-content6">
									<span id="popupClose">&times;</span>
									<h2>Paiement reçu ?</h2>
									<form class="selectForm" action="<?php echo base_url('Googleads/paiement_recu'); ?>" method="POST">
                                            <input type="hidden" name="idonnee" value="<?php echo $C->idonnee; ?>" required>
                                            <select id="popupSelect" name="paiement_recu">
							...
							<div id="popupYesOrNoEmail" class="popup">
								<div class="popup-content6">
									<span id="popupClose">&times;</span>
									<h2>Email Onboarding</h2>
									<form class="selectForm" action="<?php echo base_url('Googleads/email_onboarding'); ?>" method="POST">
                                            <input type="hidden" name="idonnee" value="<?php echo $C->idonnee; ?>" required>
                                            <select id="popupSelect" name="paiement_recu">
												<option value="1">Oui</option>
												<option value="0">Non</option>
							...
							<div id="popupYesOrNoFacturation" class="popup">
								<div class="popup-content6">
									<span id="popupClose">&times;</span>
									<h2>Facturation</h2>
									<form class="selectForm" action="<?php echo base_url('Googleads/facturation'); ?>" method="POST">
                                            <input type="hidden" name="idonnee" value="<?php echo $C->idonnee; ?>" required>
                                            <select id="popupSelect" name="paiement_recu">
												<option value="1">Oui</option>
												<option value="0">Non</option>
