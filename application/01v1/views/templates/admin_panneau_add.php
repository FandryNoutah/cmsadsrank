				...
				<?php echo form_open_multipart('panneau/add',array('class'=>'form-horizontal form-simple form'));?>
					<div class="form-body">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label for="panneau_date_pose">Date pose <?php echo form_error('panneau_date_pose'); ?></label>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<?php echo form_dropdown('panneau_couverture_adsl', $yesno, 0,'id="panneau_couverture_adsl" class="form-control"'); ?>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label for="panneau_regisseur">Visuel actuel <?php echo form_error('panneau_visuel_actuel'); ?></label>
									<?php echo form_dropdown('panneau_visuel_actuel', $all_visuel, 1,'id="panneau_visuel_actuel" class="form-control"'); ?>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<label><?php //echo form_error('panneau_visuel_actuel_path'); ?></label>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
