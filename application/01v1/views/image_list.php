...
<div class="container">
    ...
    <?php echo anchor("Googleads/Visualiserlocal/".$images[0]->idgroupe_annonce, '<h6 class="btn btn-success mr-3">Enregistrer</h6><i class="button"></i>', 'data-edit="'.$images[0]->idgroupe_annonce.'"'); ?>
            <?php endif; ?>  
            <?php  if($clients->type_campagnes == 3): ?>
    <?php echo anchor("Googleads/Visualiserpmax/".$images[0]->idgroupe_annonce, '<h6 class="btn btn-success mr-3">Enregistrer</h6><i class="button"></i>', 'data-edit="'.$images[0]->idgroupe_annonce.'"'); ?>
            <?php endif; ?>      
    <?php endif; ?>  
