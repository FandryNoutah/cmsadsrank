...
class Visuels_model extends CI_Model {
	...
	public function updatescampagne($zones,$date_campagne,$appareil,$budget,$information_campagne,$idcampagne){
		$this->db->escape($information_campagne);
		$sql = "update campagne set zones='".$zones."',date_campagne='".$date_campagne."',appareil='".$appareil."',repartition_budget='".$budget."',information_campagne='".$information_campagne."' where idcampagne='".$idcampagne."'";
		$this->db->query($sql);
		$this->db->close();
	}
	public function updatescampagnes($zones, $date_campagne, $appareil, $budget, $idcampagne){
		$sql = "update campagne set zones='".$zones."',date_campagne='".$date_campagne."',appareil='".$appareil."',repartition_budget='".$budget."' where idcampagne='".$idcampagne."'";
		$this->db->query($sql);
		$this->db->close();
	}
	public function updatesgroupe($nom_groupe,$mot_cle,$idgroupe_annonce){
		$sql = "update groupe_annonce set nom_groupe='".$nom_groupe."',mot_cle='".$mot_cle."' where idgroupe_annonce='".$idgroupe_annonce."'";
		$this->db->query($sql);
		$this->db->close();
	}
