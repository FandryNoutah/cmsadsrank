...
class Resiliation extends MY_Controller {
	...
	public function index() {
		...
		$ko = $this->data['resiliation'] = $this->visuels_model->getresiliation();
		...
		$this->page = "templates/v3/resiliation.php";
		$this->layout();
	}
	public function uptates_information_resiliation() {
		...
		$updateResult = $this->Donne_modele->update_information_resiliation(
			$idonnee,
