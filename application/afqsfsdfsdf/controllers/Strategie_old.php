...
class Strategie extends MY_Controller
{
	...
	public function index() {
		...
		$this->data['tache_team_non_complete'] = $this->Task_model->get_task_team(2);
		$this->data['temporaire'] = $this->Task_model->get_task_temporaire();
		$this->data['temporaire_non_complete'] = $this->Task_model->get_task_temporaire(2);
		$this->data['gtm'] = $this->Task_model->get_task_gtm();
		$this->data['gtm_non_complete'] = $this->Task_model->get_task_gtm(2);
