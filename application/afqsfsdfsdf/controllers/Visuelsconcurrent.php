...
class Visuelsconcurrent extends MY_Controller {
	...
	public function index() {
		...
		$this->page = "templates/admin_visuelsconcurrent";
		$this->layout();
	}

	public function getConcurrent(){
        $page = "templates/admin_visuelsconcurrent";
        $listeConcurrent = $this->Concurrent->getConcurrent();
	...
	public function getVisuel(){
		...
		$page = "templates/admin_visuelsconcurrent";
        $visuels = $this->visuels_model->getVisuels();
