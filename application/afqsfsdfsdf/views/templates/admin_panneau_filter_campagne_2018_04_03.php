	...
	<div class="col-lg-12">
		...
		<div class="card">
									...
									<?php foreach($panneauRow as $keyCol => $panneauCol) : ?>
										...
										<?php if(!is_array($panneauCol) && !in_array($keyCol, $hide)) : ?>
											<?php
												switch ($keyCol) {
													case 'panneau_format':
														$panneauCol = $filters["_formats"][$panneauCol]["format"];
														break;
													case 'panneau_type':
														$panneauCol = $filters["_types"][$panneauCol]["type"];
														break;
													case 'panneau_province':
														$panneauCol = $filters["_provinces"][$panneauCol]["label"];
														break;
													case 'panneau_axe':
														$panneauCol = $filters["_axes"][$panneauCol]["label"];
														break;
													case 'panneau_sam':
														$panneauCol = $filters["_sam"][$panneauCol]["label"];
														break;
													case 'panneau_regisseur':
														$panneauCol = $filters["_regisseurs"][$panneauCol]["label"];
														break;
													...
													case 'panneau_couverture_adsl':
														$panneauCol = $filters["_yesno"][$panneauCol];
														break;
													default:
														break;
												}
												...
												<?php foreach($filters["_campagnes"] as $k_id => $id_campagne): ?>
													...
													<td style="background-color: lightgray;<?php echo $borderColor; ?>">
														...
														<?php 
															...
															$visuel_array = (isset($filters["_visuels"]) && $idd) ? $filters["_visuels"][$idd] : array();
			...
			<div class="btnControls">
			    ...
			    <a href="<?php echo base_url("export") ?>" target="_self" class="btn btn-success upgrade-to-pro" id="dataExport">Exporter XLS</a>
			    
				<button class="btn btn-success massAction maj_campagne" id="maj_campagne" data-toggle="modal" data-target="#inlineMaj" >Mettre à jour <span>(0 éléménts)</span></button>
				<!--<div class="btn-group">
			...
			<div class="modal fade text-xs-left" id="inlineMaj" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form action="<?php echo base_url("panneau/addcampagne") ?>" enctype="multipart/form-data" method="post" id="majCampagne">
