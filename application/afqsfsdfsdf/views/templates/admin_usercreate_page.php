<div class="col-md-12">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title" id="basic-layout-colored-form-control">Création utilisateur</h4>
		...
		<div class="card-body collapse in">
			<div class="card-block">
				...
				<?php echo form_open("admin/user/create"); ?>
					<div class="form-body">
						<h4 class="form-section"><i class="icon-eye6"></i> à propos utilisateur</h4>
						<div class="row">
							<div class="col-md-6">
						...
						<h4 class="form-section"><i class="icon-mail6"></i> Contact Infos</h4>
						...
						<div class="row">
							...
							<!-- <div class="col-md-4">
								<div class="form-group">
									<label for="phone">SAM <?php echo form_error('sam_id', '<span class="error">', '</span>'); ?></label>
									<?php echo form_dropdown('sam_id', $sam_id, 0, $attributes); ?>
								</div>
							</div> -->
						</div>
						...
						<pre>
							...
							<?php //print_r($this->ion_auth->user()); ?>
