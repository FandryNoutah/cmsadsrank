								...
								<?php foreach($valueRow as $keyCol => $valueCol) : ?>
									<?php if(!is_array($valueCol) && !in_array($keyCol, $hide)) : ?>
										<td>
											...
											<?php
												echo $keyCol != 'visuels' ? $valueCol : '<img width="100" src="' . base_url($valueCol) . '" />'
											?>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div id="modal-form-new">
							...
							<form action="<?php echo site_url('campagne/add')?>" method="post">
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<div class="position-relative has-icon-left">
											...
											<?php echo form_input(["type" => "date", "name" => "date_debut", "id" => "date_debut" ], '', 'class="form-control" required'); ?>
									...
									<div class="form-group">
										...
										<div class="position-relative has-icon-left">
											<?php //echo form_input(["type" => "date", "name" => "date_visuel"], $data->date_visuel, 'class="form-control"', 'required'); ?>
											<?php echo form_input(["type" => "date", "name" => "date_fin", "id" => "date_fin" ], '', 'class="form-control" required'); ?>
											<div class="form-control-position">
												<i class="icon-calendar5"></i>
											</div>
										</div>
