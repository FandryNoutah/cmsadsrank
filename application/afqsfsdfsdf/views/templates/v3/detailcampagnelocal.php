...
<div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-colored-form-control">Google Ads - Technique - Local
                    <style>
...
popupOverlay.onclick = function() {
    ...
    popupOverlay.style.display = 'none';
                        ...
                        <?php foreach($campagne as $D): ?>
                            ...
                            <?php // echo anchor("Googleads/ajout_groupeannonce_local/".$D['idcampagne'], '<h6 class="btn btn-secondary mr-2">Ajout groupe annonce Local</h6><i class="button"></i>', 'data-edit="'.$D['idcampagne'].'"'); ?>
            ...
            <section>
                ...
                <tr>
                    ...
                    <td><?php echo anchor("Googleads/ajout_groupeannonce_local/".$D['idcampagne'], '<h6 class="fas fa-plus"></h6><i  class="button" ></i>','data-edit="'.$S['idgroupe_annonce'].'"') ;?></td>
                    <td><?php 
                                                    if (isset($D['idclients'])) {
                                                        echo anchor(
                                                            'ImageScraper/vie2/' . $D['idclients'], 
                                                            'Gestion image',
