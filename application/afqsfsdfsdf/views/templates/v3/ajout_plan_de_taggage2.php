<h4 class="card-title" id="basic-layout-colored-form-control">Google Ads - Plan de taggage - Technique </h4>
							...
							<form action="<?php echo site_url('Plan_de_taggage/Ajoutplantaggage'); ?>" method="POST" enctype="multipart/form-data">
                                    <div id="annonce-groups">
                                        ...
                                        <input type="text" name="convarsion_label" class="form-control" > <br>
											<button type="submit" class="btn btn-success" style="font-size: 16px; font-weight: 500;background-color: #4EA5FE;">Ajouter</button>
											</form>
                                            </div>
                                            </div>   