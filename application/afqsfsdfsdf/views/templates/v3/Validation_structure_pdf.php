            ...
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #dee2e6; background-color: #fff;">
                <thead style="background-color: #007bff; color: #fff;">
                    <tr>
                        ...
                        <th style="padding: 12px; border: 1px solid #dee2e6;width: 120px;">Mots-clés</th>
                    </tr>
                </thead>
                <tbody>
                ...
                <div class="container">
                    <div class="block">
                        ...
                        <div class="ad-item">
                            ...
                            <div class="ep-btn" style="text-align: left! important;">
                ...
                <div class="container">
                    <div class="block">
                        ...
                        <div class="ad-item">
                            ...
                            <img src="<?= !empty($images[3]->image_base64) ? $images[3]->image_base64 : $images[3]->image_base64;  ?>" alt="Image" style="max-width: 160px; object-fit: cover;">
                    ...
                    <div class="block">
                        ...
                        <div class="ad-item">
                            ...
                            <div class="container2">
                                ...
                                <div class="col2">
                                    <?php echo '<img src="' . $images[1]->image_base64 . '" width="160" height="auto" />'; ?>
                                </div>
                            </div>
                        </div>
            ...
            <div class="header-mine">
                <div class="container">
                    <div class="block">
                        ...
                        <div class="ad-item">
                            <img src="<?= $images[1]->image_base64 ?>" alt="Image" style="max-width: 160px; object-fit: cover;">
                            <p style="font-size: 9px;text-align: left! important"><b>Annonce - </b> <?php echo $clients[0]['nom_client']; ?></p>
                                <a href="#" style="font-size: 9px;">En savoir plus</a>
                        </div>
