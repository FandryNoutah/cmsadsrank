...
<div id="exportable-content">
    ...
    <?php 
echo anchor(
    "Plan_de_taggage/ajoutplandetaggage/".$C['idclients'],
    '<span style="display: inline-block; text-align: center; line-height: 41px; font-size: 16px; font-weight: 500; margin-top: 20px; margin-left: 0px; width: 250px; height: 41px; background-color: #4EA5FE; color: white! important; border-radius: 20px; text-decoration: none;">Ajouter plan de taggage</span>',
    ...
    <table id="campaign-table">
        ...
        <tbody>
            ...
            <tr data-id="<?php echo $P['idplan_de_taggage']; ?>"> 
                <td> <?php echo anchor(
                            "Plan_de_taggage/deleteplandetagggage/".$P['idplan_de_taggage'], 
...
document.getElementById('modalForm').addEventListener('submit', function(e) {
    ...
    xhr.open('POST', '<?php echo site_url('Plan_de_taggage/updateData'); ?>', true);
...
<div id="editTaskModal" class="modal">
    <div class="modal-content">
        ...
        <form id="editTaskForm" action="<?php echo site_url('Plan_de_taggage/edit_task'); ?>" method="POST">
...
document.querySelectorAll('.openEditModalBtn').forEach(button => {
    button.addEventListener('click', function(event) {
        ...
        var date_demande = this.getAttribute('data-date_demande');
        var date_due = this.getAttribute('data-date_due');
        ...
        document.getElementById('date_due').value = date_due;
