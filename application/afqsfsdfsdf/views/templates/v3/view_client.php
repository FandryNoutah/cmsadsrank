<div class="col-md-12">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title" id="basic-layout-colored-form-control">Résumeé du client</h4>
			...
			<div class="card-block">
				...
				<?php foreach($client as $C){ ?>
					<?php foreach($donnees as $D){ ?>
						...
						<label for="fname"><b>Initiative :</b> <?php echo $idinitiative[0]['last_name']; ?> <?php echo $idinitiative[0]['first_name']; ?></label>
						<label for="fname"><b>Account account_manager :</b> <?php echo $idam[0]['last_name']; ?> <?php echo $idam[0]['first_name']; ?></label>
