...
class Campagne_model extends CI_Model {
    ...
    public function getPanneauByFilter($array = null) {
        ...
        $query = $this->db->select("hm_panneau.*, hm_campagne_visuel.visuel_id as visuel_id, hm_campagne_visuel.campagne_id as campagne_id")
                      ->from("hm_panneau")
                      ->join("hm_campagne_visuel", "hm_panneau.id=hm_campagne_visuel.panneau_id")
                      ->get();
